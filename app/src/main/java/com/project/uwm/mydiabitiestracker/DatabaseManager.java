...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    private static final String alertTable = "CREATE TABLE IF NOT EXISTS "
            +ALARMTABLE + " (" + AID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + USER_NAME + " TEXT," +ALARMTIME  + " TEXT," +ONETIME+" TEXT," +ACTIVE+" TEXT," +LABEL + " TEXT,"+ METRIC + " TEXT";
    ...
    public boolean addReminder(ReminderObject ro){
        return true;
    }
